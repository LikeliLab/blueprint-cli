...
export function showTitle(content) {
...
export function showCompletion(message) {
    console.log(boxen(`${warmTerracotta.bold(message)}`, { padding: 1, margin: 1, borderStyle: 'double', borderColor: '#6A3E9C' }));
}
 ...
 */
export function stopSpinner(spinnerInstance) {
    if (spinnerInstance) {
 ...
 */
export function succeedSpinner(spinnerInstance, text) {
    if (spinnerInstance) {
 ...
 */
export function failSpinner(spinnerInstance, text) {
    if (spinnerInstance) {
